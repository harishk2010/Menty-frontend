...
import { ChevronLeft, ChevronRight, ArrowUpDown, UsersIcon, Search, Settings } from "lucide-react";
      ...
      >
        ...
        <div className="bg-gray-800 px-6 py-5 rounded-lg shadow-lg border border-gray-700 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-semibold text-indigo-300">Instructor Management</h1>
          </div>
          <div className="text-sm text-gray-400">
            <span className="text-purple-400 font-medium">{filteredData.length}</span> total instructors
          </div>
        </div>
        ...
        <div className="bg-gray-800 rounded-lg shadow-lg border border-gray-700 overflow-hidden">
          {loading ? (
            ...
            <div className="p-8 text-center">
              ...
              <p className="mt-4 text-gray-400">No instructors found</p>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-center">
                        {user.isBlocked ? (
                          <AlertDialog
                            ...
                            alert={"Do you want to unblock this instructor?"}
                          >
                          ...
                          <AlertDialog
                            onConfirm={() => handleBlock(user.email)}
                            alert={"Do you want to block this instructor?"}
                          >
